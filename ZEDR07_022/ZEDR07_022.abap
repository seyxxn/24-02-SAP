...
DATA : GT_STUDENT LIKE TABLE OF GS_STUDENT WITH NON-UNIQUE KEY ZGENDER. "지우려고 하는 필드 기준으로 KEY를 설정하기
...
DELETE TABLE GT_STUDENT WITH TABLE KEY ZGENDER = 'F'. "키 값 기준으로 필요없는 필드를 삭제
