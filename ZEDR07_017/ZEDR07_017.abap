...
DATA : GT_STUDENT LIKE TABLE OF GS_STUDENT WITH NON-UNIQUE KEY ZCODE. "키 값 기준으로 수정
...
MODIFY TABLE GT_STUDENT FROM GS_STUDENT TRANSPORTING ZGENDER. "변경을 원하는 컬럼을 지정해줌
